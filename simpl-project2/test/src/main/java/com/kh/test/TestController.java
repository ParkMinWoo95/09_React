...
public class TestController {
	 ...
	 * 
	 * 각각의 Starter는 관련된 라이브러리들의 집합으로 모든 의존성을 하나의 Starter로 쉽게 추가할 수 있다
	 * 
	 * 예)
	 * spring-boot-starter-web : 웹 애플리케이션 개발에 필요한 의존성들
	 * (Servlet, 스프링 MVC, Jackson 등)
	 * spring-boot-starter-security : 스프링 시큐리티와 관련된 의존성들
	 * 
	 * 필요한 기능에 맞는 Starter만 추가하면 되니까 의존성을 직접관리할 필요가 없음
	 * 모든 개발자가 동일한 Starter를 사용하기 때문에 프로젝트 간 의존성 충돌도 방지할 수 있다
	 * 
	 * * Starter에 모든 라이브러리가 존재하는 것을 아님
	 * 
	 */
